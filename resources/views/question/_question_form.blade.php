@csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="body" id="question-body" class="form-control {{ $errors->has('body')?'is-invalid':'' }}">{{old('body',$question->body)}}</textarea>
                            @if ($errors->has('body'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" id="question-title" class="btn btn-primary btn-lg">{{ $btn_text }}</button>
                        </div>